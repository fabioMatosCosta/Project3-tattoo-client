            ...
            <DefaultLayout>
                ...
                <div className="columns card">
                    <Link to="/museum">
                     ...
                     <div className="card-content is-overlay text">Tattoo History Museum</div> 
                    </Link>
                    <Link to="/heal">
                            <div className="column is-centered card-image">
                        ...
                        <div className="card-content is-overlay">Tattoo Healing</div> 
