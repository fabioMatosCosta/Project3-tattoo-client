...
class Heal extends Component {
    ...
    render() {
        return (
            <DefaultLayout>
                <br/>
            <div className="container has-text-left has-background-light all-of-it">
...
<br/>
<br/>
<h5 className="title has-text-centered">Can I Use Coconut Oil on My New Tattoo?</h5>
<br/><br/>
...
<br/><br/>
<h5 className="title">What Should I Avoid in the Process of Tattoo Aftercare?
</h5>
...
<br/><br/>
<h4 className="title">What Are the Symptoms I Should Be Aware of in Regards to My New Tattoo?</h4>
<br/>
