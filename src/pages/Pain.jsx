...
class Pain extends Component {
    ...
    render() {
        return (
            <DefaultLayout>
                <br/>
            <div className="container has-text-left has-background-light">
            <h2 className="title">There’s no way around it, all tattoos hurt! However, certain areas generally hurt more than others. These are the ten most painful places to get a tattoo.</h2>
...
Although everyone has different thresholds of pain for various tattoo spots, the head is universally known to be the most painful place to get a tattoo for many people. Much like other areas which are known for being especially painful for getting tattoos, the head has a low fat, muscle, and skin content. Because of this, there is a very small protective layer between the artist’s needle and the customer’s skull. Tattoos in areas where the artist works close to bone, such as a skull, tend to be quite painful. Also, according to healthline, the Ophthalmic division of the Trigeminal nerve is a nerve on the head which conveys sensory information from the scalp and forehead to the brain. Since the trigeminal nerve is located on the head, this area is especially sensitive to tattooing. Lastly, many people claim that the most painful part of getting a head tattoo is not actually the physical pain. Instead, a large amount of the pain is mental since the vibrations and noises the head experiences when getting a tattoo on the head often becomes undeniably unbearable.
...
<br/>
<h5 className="title is-4">Rib Cage Tattoos</h5>
...
Nambuki on my inside thigh... Done yesterday ⚔️🇯🇵⚔️ Follow me on Instagram 1tombrennan #namakubitattoo #Namakubi #japanesetattoo #japanese #blood #girl #blackandgrey #blackwork #blackworktattoo#news #samurai #newschooltattoo #newschool 
<br/><br/>
<div className="has-text-centered">
